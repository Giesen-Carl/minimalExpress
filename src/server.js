...
import { getAllBestellungen, getAllCocktails, getAllCocktailsWithIngredients, getIngredientsFromCocktail, getUserByUUID } from './database/queries.js';
...
const start = async () => {
    ...
    const b = await getAllBestellungen();
    console.log(b)
};
